			...
			hBTConfigHandler = new Handler(Looper.myLooper()){
				public void handleMessage(android.os.Message msg) {
					...
					case CMD_CLOSE_BTSOCKET:
						...
						break;
					/* send system command */
//					case CMD_SEND_SYSCMD:
//						Log.w(TAG,"BTCommand.CMD_SEND_SYSCMD");
//						
//						String cmd = msg.getData().getString(GlobalParams.KEY_SYSCMD);
//						Log.d(TAG,"syscmd : "+ cmd);
////						mBTConfig.sendCLICommand(cmd);
					default:
						break;
					}
				}
