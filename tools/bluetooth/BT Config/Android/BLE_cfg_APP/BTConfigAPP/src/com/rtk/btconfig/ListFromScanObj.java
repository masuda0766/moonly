...
public class ListFromScanObj {
	...
	private final byte[] RSSI_STRENGTH_ARRAY 			= 	{WIFI_GRADE1,	WIFI_GRADE2, 
															 WIFI_GRADE3,	WIFI_GRADE4};
		...
		for(ScanObj scanItem: scanResults) {	//2.4G	
			...
			/* repeater status */ 
			 if(mListType == ListBaseAdapter.LIST_EXTENDED_AP){ 
				 ...
				 case 0:
					 map_item.put("list_item_encrypt", R.drawable.encrypt_open);
					 break;
				 case 1:
				 case 2:
					 map_item.put("list_item_encrypt", R.drawable.encrypt_lock);
					 break;
				 default:
