...
DRAM_C += ../../../component/common/api/at_cmd/atcmd_audrey.c
else
...
#SDRAM - audrey
DRAM_C += ../src/wdt.c
DRAM_C += ../src/link_key.c
DRAM_C += ../src/led_util.c
DRAM_C += ../src/temperature.c
DRAM_C += ../src/scale.c
DRAM_C += ../src/scale_up.c
DRAM_C += ../src/scale_xmodem.c
DRAM_C += ../src/weight.c
DRAM_C += ../src/badge.c
DRAM_C += ../src/data_upload.c
DRAM_C += ../src/state_manager.c
DRAM_C += ../src/webserver.c
DRAM_C += ../src/fast_connect.c
DRAM_C += ../src/rf_ctrl.c
DRAM_C += ../src/rf_ctrl_wifi.c
DRAM_C += ../src/rf_ctrl_ble.c
DRAM_C += ../src/ota_http_client.c
DRAM_C += ../src/ble_scan.c
DRAM_C += ../src/bt_gatt_server.c
DRAM_C += ../src/ssl_my_func.c
DRAM_C += ../src/log_record.c
DRAM_C += ../src/sh_system.c
